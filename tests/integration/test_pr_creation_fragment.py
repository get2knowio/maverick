...
"""
        ...
        def mock_pr_title_context(context: dict[str, Any]) -> dict[str, Any]:
            return {
        ...
        def mock_pr_body_context(context: dict[str, Any]) -> dict[str, Any]:
            return {
                "commits": ["feat: add fragments", "test: add tests"],
        ...
        # Register components
        registry.generators.register("pr_title_generator", MockPRTitleGenerator)
        registry.generators.register("pr_body_generator", MockPRBodyGenerator)
        registry.context_builders.register("pr_title_context", mock_pr_title_context)
        registry.context_builders.register("pr_body_context", mock_pr_body_context)
    ...
    async def test_fragment_with_provided_title(
        ...
        assert events[0].workflow_name == "create-pr-with-summary"
