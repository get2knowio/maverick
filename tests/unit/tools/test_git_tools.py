...
class TestHelperFunctions:
    ...
    async def test_verify_git_prerequisites_success(
        ...
        with patch(
            "maverick.tools.git.prereqs.GitRunner", return_value=mock_git_runner
        ):
            # Should not raise
...
class TestGitCommit:
    ...
    @pytest.mark.asyncio
    async def test_git_commit_success(self, mock_git_runner: MagicMock) -> None:
    ...
    async def test_git_commit_nothing_to_commit(
        ...
        """
        mock_git_runner.commit = AsyncMock(
            return_value=GitResult(
                success=False,
    ...
    @pytest.mark.asyncio
    async def test_git_commit_git_error(self, mock_git_runner: MagicMock) -> None:
...
class TestGitPush:
    ...
    @pytest.mark.asyncio
    async def test_git_push_success(self, mock_git_runner: MagicMock) -> None:
        ...
        with patch(
            "maverick.tools.git.tools.push.GitRunner", return_value=mock_git_runner
        ):
            server = create_git_tools_server()
    ...
    @pytest.mark.asyncio
    async def test_git_push_detached_head(self, mock_git_runner: MagicMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_git_push_auth_required(self, mock_git_runner: MagicMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_git_push_network_error(self, mock_git_runner: MagicMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_git_push_not_a_repository(self, mock_git_runner: MagicMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_git_push_set_upstream(self, mock_git_runner: MagicMock) -> None:
...
class TestGitCurrentBranch:
    ...
    @pytest.mark.asyncio
    async def test_git_current_branch_success(self, mock_git_runner: MagicMock) -> None:
...
class TestGitDiffStats:
    ...
    @pytest.mark.asyncio
    async def test_git_diff_stats_success(self, mock_git_runner: MagicMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_git_diff_stats_no_changes(self, mock_git_runner: MagicMock) -> None:
...
class TestGitCreateBranch:
    ...
    @pytest.mark.asyncio
    async def test_git_create_branch_success(self, mock_git_runner: MagicMock) -> None:
        ...
        """
        mock_git_runner.create_branch = AsyncMock(
            return_value=GitResult(
                success=True,
    ...
    @pytest.mark.asyncio
    async def test_git_create_branch_exists(self, mock_git_runner: MagicMock) -> None:
