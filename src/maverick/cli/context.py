...
class FlyCommandInputs:
    ...
    def to_fly_inputs(self) -> FlyInputs:
        """Convert CLI inputs to workflow FlyInputs.

        Returns:
            FlyInputs instance for workflow execution.
        """
        return FlyInputs(
...
class RefuelCommandInputs:
    ...
    def to_refuel_inputs(self) -> RefuelInputs:
        """Convert CLI inputs to workflow RefuelInputs.

        Returns:
            RefuelInputs instance for workflow execution.
        """
        return RefuelInputs(
            label=self.label,
            limit=self.limit,
