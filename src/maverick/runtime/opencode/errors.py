...
The canonical error hierarchy now lives in :mod:`airframe.errors`. This
module re-exports those names so existing
...
New code should import from :mod:`airframe.errors` directly.
"""
