"""Refuel Workflow orchestrator implementation.

This module provides the RefuelWorkflow class which orchestrates the tech-debt
resolution workflow.
"""
    ...
    async def execute(
        ...
        if self._use_dsl:
            try:
                ...
                # Tests patch "maverick.workflows.refuel.WorkflowFileExecutor"
                from maverick.workflows.refuel import WorkflowFileExecutor
